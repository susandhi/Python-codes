...
#Tops = Frame(root, width = 300, height = 50, bg = "powder blue", relief = SUNKEN)
#Tops.pack(side = TOP)
...
#====================Info==========================================================================================================
#lblInfo = Label(Tops, font = ('arial', 50, 'bold'), text = "Basic Calculator", fg = "Steel Blue", bd = 10, anchor = 'w')
